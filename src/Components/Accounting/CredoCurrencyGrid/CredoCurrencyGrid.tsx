...
const CredoCurrencyGrid: React.FC = () => {
  const { data, isPending } = useFetch({url: 'http://129.159.131.73:5000/exchanges/credo', fetchName: 'Load rico currencies', retries: 3});
  ...
  return (
    <div className='exchange-container'>
      <SkeletonTheme
        ...
        duration={1}
      >
        <h2 className='exchange-table-name'> Credo bank </h2>
        <table>
          <thead>
            <tr>
              <th></th>
...
export default CredoCurrencyGrid;
